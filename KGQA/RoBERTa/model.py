...
class RelationExtractor(nn.Module):
    ...
    entdrop=0.0, reldrop=0.0, scoredrop=0.0, l3_reg=0.0, model='ComplEx', ls=0.0, do_batch_norm=True, freeze=True):
        ...
        # self.hidden2rel_ans = nn.Linear(self.hidden_dim, 44948)
    ...
    def getQuestionEmbedding(self, question_tokenized, attention_mask):
        ...
        # print('*****roberta_last_hidden_states.size()*****')
        # print(roberta_last_hidden_states.size())
    ...
    def forward(self, question_tokenized, attention_mask, p_head, positive_tail_tokenized, positive_tail_attentionMask):
        ...
        actual = self.getQuestionEmbedding(positive_tail_tokenized, positive_tail_attentionMask)
        device = torch.device(0)
        hidden2rel_ans = nn.Linear(self.hidden_dim, 44948).to(device)
        actual = hidden2rel_ans(actual)
        # print("##########ACTUAL############")
        # print(actual.size())
